    ...
    <div className='w-full h-auto p-2 ml-[-5%] mt-[-1px]  xl:mt-[-40px] hidden md:block mb-2 lg:mb-10 xl:mb-30'>
        <div className="w-full px-0 flex flex-row pl-0 md:pl-15 xl:pl-40 gap-20 xl:gap-30">
          ...
          <div className="mt-10 w-[400px] xl:w-[50%]">
            <h2 className='text-2xl xl:text-3xl font-bold text-[#A0763F] mt-5 xl:mt-30 flex text-right'>Why Zaxbox?
            </h2>
            <div className="block w-30 h-1 mx-auto md:mx-0 rounded-tr-md rounded-br-md rounded-bl-md  border-b-8 border-[#D3B466] mt-2 mb-3"></div>
             ...
             <p className=' font-light text-xl leading-7'>Your trust is what we value above everything else. We want to be a reliable service for everyone, and our team knows that your trust is a reward for the excellent job. To win this reward, we provide the high-quality service and care about every customer..</p> <br /><br />
...
{/* MOBILE */}
      ...
      <div className="flex flex-col sm:hidden p-2 h-auto mb-4">



      <div className="mt-10 px-2">
        <h2 className='flex  text-2xl font-bold text-[#A0763F]  text-start'>Why Zaxbox?
        </h2>
